...
hesperidesServices.factory('Properties', ['$resource', function ($resource) {
    ...
    var Properties  = $resource('http://localhost:8080/rest/properties/:version/:application/:platform/:filename', {version: '@version', application: '@application', platform: '@platform', filename: '@filename'}, {
        put: {method: 'PUT'},
...
hesperidesServices.factory('Template', ['$resource', function ($resource) {
    ...
    var Template = $resource('http://localhost:8080/rest/templates/:version/:application/:filename', {version: '@version', application: '@application', filename: '@filename'}, {
        put: {method: 'PUT'},
		all: {method: 'GET', isArray: true}
    });
